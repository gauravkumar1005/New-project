...
const CreateAgent = () => {
  ...
  const [modalData, setModalData] = useState({ title: "", start: "", end: "", desc: "" });
  ...
  const saveEvent = () => {
    ...
    setEvents([
      ...events,
      { id: Date.now(), date: iso, ...modalData },
    ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        navigate("/my-agents"); // <-- redirect added
      } else {
    ...
    <MainLayout>
      <div className="flex justify-center py-10 bg-gray-50 min-h-screen">
        <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-3xl">
          <h1 className="text-3xl font-semibold mb-6">Create Agent</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {agentType === "shop" && (
              <div className="border p-4 rounded-md">
                ...
                {items.map((it) => (
                  <div key={it.id} className="grid grid-cols-12 gap-3 items-center mb-3">
                    <input
            ...
            {agentType === "event" && (
              <div className="border p-4 rounded-md">
                ...
                <div className="flex justify-between mb-2">
                  <button type="button" onClick={() => setCalMonth((m) => (m === 0 ? 11 : m - 1))}>◀</button>
                  <strong>
                  ...
                  <button type="button" onClick={() => setCalMonth((m) => (m === 11 ? 0 : m + 1))}>▶</button>
                </div>
